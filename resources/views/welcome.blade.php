<x-landing-layout>
  ...
  <div class="relative px-6 lg:px-8">
    <div class="mx-auto max-w-3xl pt-8 pb-32 sm:pt-8 sm:pb-40 relative z-1">
      <div>
        <img class="flex m-auto w-[200px] sm:w-[250px] pb-10" src="{{ asset('img/comida.png') }}" alt="">
  ...
  <!-- Menu section -->
  <div class="relative px-6 lg:px-8" id="ourMenu">
    <div class="mx-auto max-w-3xl pt-8 pb-32 sm:pt-8 sm:pb-40 relative z-1">
        <div class="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          <h2 class="text-2xl font-bold text-center tracking-tight text-gray-900 dark:text-gray-300">Our Menu</h2>
